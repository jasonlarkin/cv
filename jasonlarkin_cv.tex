...
\setitemize{leftmargin=10pt,itemindent=10pt, noitemsep, topsep=3pt, parsep=2pt, partopsep=1pt}
...
%    \item Machine Learning: SVM, KMeans, Natural Language Processing...     
  ...
  \item \textbf{"Full-Stack" Computation}
  \begin{itemize}
