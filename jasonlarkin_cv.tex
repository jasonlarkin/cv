...
%    \item Spanned range of languages from "nearly-assembly" C to JavaScript/Python/etc.  
    \begin{itemize}
      ...
      \item \textbf{\href{http://spiral.net/}{Spiral}}: supported the work of several major research and commercial projects around the Spiral toolchain, creating automatically-optimized / \href{https://en.wikipedia.org/wiki/Formal_methods}{formally-verified} kernels for \textbf{\href{https://en.wikipedia.org/wiki/Cyber-physical_system}{Cyber-Physical Systems}} and \textbf{high performance computing (HPC)}.
...
%\href{https://wiki.hh.se/wg211/images/e/e0/M13Franchetti.pdf}{HCOL}
    ...
    \item \textbf{\href{http://www.darpa.mil/Our_Work/MTO/Programs/Power_Efficiency_Revolution_for_Embedded_Computing_Technologies_(PERFECT).aspx}{Power Efficiency Revolution for Embedded Computing Technologies (PERFECT, \href{http://www.darpa.mil/default.aspx}{DARPA})}}
      ...
      \begin{itemize}
        ...
        \item Eclipse RCP developed for first commerical release of SpiralFFT. 
      \end{itemize}

  \end{itemize}

      \item \textbf{Funding and Resource Proposals}: track record of submitting and being awarded.
        \begin{itemize}
          \item \textbf{\href{http://science.energy.gov/sbir/}{DOE Small Business Innovation Research (SBIR)}} (co-wrote, Phase 1 awarded, Phase 2 submitted): 

          \item \textbf{CFD Acceleration using Spiral} SBIR (PI, Phase 1 submitted): 
          ...
          \item \textbf{Spiral on \href{http://www.psc.edu/index.php/bridges}{PSC Bridges}} (PI, submitted)

          \item \textbf{Optimization of 3-D FFTs for Intel Xeon Phi and NVIDIA Kepler K20 GPUs using Spiral} (PI, submitted, awarded)
...
\item \textbf{\href{http://ntpl.me.cmu.edu/research.html}{Nanostructure Thermal Conductivity}:} investigator under the 
...
\item \textbf{\href{https://github.com/jasonlarkin/pcm-potentials}{pcm-potentials}}: fit hypersurfaces using nonlinear optimization.
